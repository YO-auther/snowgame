...
const imageNames = [
    ...
    "collector","deliver","snow","gold_snow","dead_snow",
...
let snowflakes = [];
class Snow {
    constructor(type){ this.type=type; this.size=100; this.x=Math.random()*(canvas.width-this.size); this.y=-50; this.speed=1+Math.random()*2;}
...
const PLAYER_SIZE=90,PRESENT_SIZE=80,HOUSE_SIZE=130;
